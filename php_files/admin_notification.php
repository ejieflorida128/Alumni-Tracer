    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <a href="admin_notification.php" class="nav-item nav-link active"><i class="fa fa-bell me-2"></i>Notification</a>
        ...
        <div class="col-lg-12 right">
                        ...
                        ?>
                                ...
                                <div class="p-3 d-flex align-items-center bg-light border-bottom osahan-post-header">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="pictures/Default.png" alt="" />
                                    </div>
                                    ...
                                    <div class="text-truncate" style="margin-left: 10px; font-size: 12px; font-weight: bolder; display: flex; justify-content: space-between;">
                                        ...
                                        <div class="small" style = "margin-left: 10px;"><?php echo $resultData['notification']; ?></div>
                                    </div>
            ...
            <div class="box shadow-sm rounded bg-white mb-3">
                    ...
                    <div class="box-body p-0">
                        ...
                        <?php
                      $school_name2 = $_SESSION['school'];
                      $decryptSchool2 = decryptData($school_name2);
                        $sqlEarlier = "SELECT * FROM e_notifications
                                    WHERE school_name = '$decryptSchool2' 
                                    ORDER BY id DESC 
