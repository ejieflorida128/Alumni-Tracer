            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-12">
                    <div class="bg-light rounded h-100 p-4">
                        <h6 class="mb-4">Pending Response Table</h6>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    if (isset($_GET['delete_id'])) {
                                        ...
                                        $stmt = $conn->prepare("DELETE FROM l_study_response WHERE id = ?");
                                        $stmt->bind_param("i", $delete_id);
                                        $result = $stmt->execute();

                                        if ($result) {
                                            echo "<script>alert('Delete Successful!'); window.location.href = 'response.php';</script>";
                                        } else {
                                            echo "<script>alert('Delete Unsuccessful. There was an error deleting the Response.'); window.location.href = 'response.php';</script>";
                                        }
                                        $stmt->close();
                                    }

                                    // Fetch existing responses
                                    $sql = "SELECT * FROM l_study_response WHERE status = 'pending' ORDER BY id DESC";
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        echo "<tr><td colspan='54' class='text-center text-danger'>No results found</td></tr>";
                                    }
                                    $conn->close();
                                    ?>
                                </tbody>
            ...
            <script>
                function confirmDelete(id) {
                    if (confirm('Are you sure you want to delete this entry?')) {
                        window.location.href = 'response.php?delete_id=' + id;
                    }
                }
            </script>
            <!-- Table End -->
